...
## Overview
This document describes the implementation of the announcements feature for the CCAP platform. Announcements can be created by admins and are filtered based on user role and location/bucket.
