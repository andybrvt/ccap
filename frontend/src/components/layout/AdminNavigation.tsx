...
import { ChevronDown, Home, FileText, Search, Settings, LogOut, Mail, Menu } from "lucide-react";
            ...
            <div className="md:hidden">
              <Sheet>
                ...
                <SheetContent side="right" className="w-80 p-6 bg-white">
                  ...
                  <div className="border-t border-line pt-4 space-y-1 mb-6">
                    <Link href="/admin/admin-management" className="flex items-center gap-3 px-3 h-10 text-sm text-ink hover:bg-secondary rounded-lg transition-colors">
                      <Settings className="w-4 h-4" />
                      <span>Admin Management</span>
                    </Link>
                    <Link href="/admin/email-notifications" className="flex items-center gap-3 px-3 h-10 text-sm text-ink hover:bg-secondary rounded-lg transition-colors">
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/admin/admin-management" className="flex items-center gap-3 px-3 h-10 cursor-pointer rounded-md hover:bg-secondary">
                      <Settings className="w-4 h-4 text-inkmuted" />
                      <span className="text-sm text-ink">Admin Management</span>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/admin/email-notifications" className="flex items-center gap-3 px-3 h-10 cursor-pointer rounded-md hover:bg-secondary">
                      <Mail className="w-4 h-4 text-inkmuted" />
